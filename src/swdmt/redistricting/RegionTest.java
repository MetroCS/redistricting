...
public class RegionTest {
    ...
    public void emptyRegionSizeTest() {
        MatcherAssert.assertThat((new Region()).size(), is(0));
        MatcherAssert.assertThat((new Region(0)).size(), is(0));
        MatcherAssert.assertThat((new Region(-0)).size(), is(0));
    }

    @Test
    public void emptyRegionNumberOfVotersTest() {
        MatcherAssert.assertThat((new Region()).numberOfVoters(), is(0));
        MatcherAssert.assertThat((new Region(0)).numberOfVoters(), is(0));
        MatcherAssert.assertThat((new Region(-0)).numberOfVoters(), is(0));
    }
    ...
    public void squareRegionValidSizeTest() {
        ...
        for (int i = 0; i < maxRegionSide; i++) {
            MatcherAssert.assertThat("Square region test failed at size " + i * i,
    ...
    public void squareRegionNumberOfVotersTest() {
        int maxRegionSide = (int) Math.sqrt(MAX_REGION_SIZE);
        for (int i = 0; i < maxRegionSide; i++) {
            MatcherAssert.assertThat("Square region number of voters failed at size " + i * i,
    ...
    public void regionWithAllVotersInLocationSetTest() {
        ...
        MatcherAssert.assertThat("Region with all voters in location set test failed; Location and Voter sets of size 2 produced Region with wrong size.", region.size(), is(2));
        MatcherAssert.assertThat("Region with all voters in location set test failed; Location and Voter sets of size 2 produced Region with wrong number of voters.", region.numberOfVoters(), is(2));
    }
    ...
    public void regionWithVoterNotInLocationSetTest() {
        ...
        Region region = new Region(locationSet, voterSet);
        MatcherAssert.assertThat("Region with no voters in the location set test failed; given Location set size 1 and Voter set size 1 produced Region with wrong size.", region.size(), is(1));
        MatcherAssert.assertThat("Region with no voters in the location set test failed; given Location set size 1 and Voter set size 1 produced wrong number of voters in the region.", region.numberOfVoters(), is(0));
    }
}
